...
parser.add_argument("algorithm", help="specify the algorithm to use ('AG' for Genetic Algorithm, 'RC' for Simulated Annealing)")
parser.parse_args()
...
def main():
    ...
    if args.algorithm == 'AG':
        ...
        print("Option invalide. Veuillez choisir 'AG' pour l'algorithme génétique ou 'RC' pour le recuit simulé.")
        return
